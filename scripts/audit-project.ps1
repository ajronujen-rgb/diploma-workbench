...
$required=@('AGENTS.md','PROJECT_STATE.md','CHATGPT_START.md','журнал_работы.md','журнал_решений.md','02_источники/реестр_источников.md','inbox/pending','inbox/processed','inbox/needs-decision')
