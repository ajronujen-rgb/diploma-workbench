...
$required=@('AGENTS.md','PROJECT_STATE.md','CHATGPT_START.md','журнал_работы.md','журнал_решений.md','01_понимание_задачи/AUTHOR_POSITION.md','01_понимание_задачи/чекпоинт_отбора.md','02_источники/реестр_источников.md','02_источники/карта_области.md','07_проверки/редакторский_qc.md','09_финал/чеклист_оформления.md','inbox/pending','inbox/processed','inbox/needs-decision')
