...
$files = @{
    ...
    '01_понимание_задачи/паспорт_исследования.md' = 'паспорт_исследования.md'; '01_понимание_задачи/AUTHOR_POSITION.md' = 'AUTHOR_POSITION.md'; '02_источники/реестр_источников.md' = 'реестр_источников.md'; '02_источники/карта_области.md' = 'карта_области.md'; '09_финал/чеклист_оформления.md' = 'чеклист_оформления.md'; '10_руководитель/шаблон_замечания.md' = 'замечание_руководителя.md'
}
