...
$files = @{
    ...
    '01_понимание_задачи/паспорт_исследования.md' = 'паспорт_исследования.md'; '02_источники/реестр_источников.md' = 'реестр_источников.md'; '10_руководитель/шаблон_замечания.md' = 'замечание_руководителя.md'
}
